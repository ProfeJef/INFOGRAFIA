...
// Layout: fila 6 es el camino, filas 0-5 el fondo/estaciones, cada estacion cada 4 columnas
...
function sceneInicio(ctx,x,y){
  ctx.fillStyle=PAL.woodLight; ctx.fillRect(x,y+16,64,48);
  ctx.fillStyle='#8b5a2b'; ctx.beginPath(); ctx.moveTo(x-6,y+16); ctx.lineTo(x+32,y-14); ctx.lineTo(x+70,y+16); ctx.closePath(); ctx.fill();
  ctx.fillStyle='#5d3a1a'; ctx.fillRect(x+24,y+36,16,28);
  ctx.fillStyle='#bfe4f5'; ctx.fillRect(x+6,y+22,12,12); ctx.fillRect(x+46,y+22,12,12);
}
function sceneLunes(ctx,x,y){
  ctx.fillStyle=PAL.woodLight; ctx.fillRect(x,y+16,64,48);
  ctx.fillStyle='#a33b2b'; ctx.beginPath(); ctx.moveTo(x-6,y+16); ctx.lineTo(x+32,y-14); ctx.lineTo(x+70,y+16); ctx.closePath(); ctx.fill();
  ctx.fillStyle='#f6c39b'; ctx.beginPath(); ctx.arc(x+20,y+48,8,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#4a6fa5'; ctx.fillRect(x+14,y+52,12,10);
  ctx.fillStyle='#a5672e'; ctx.beginPath(); ctx.ellipse(x+30,y+56,6,9,0,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#f6c39b'; ctx.beginPath(); ctx.arc(x+50,y+50,7,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#c0392b'; ctx.fillRect(x+44,y+56,14,8);
}
function sceneMartes(ctx,x,y){
  ctx.fillStyle='#d8c9a3'; ctx.fillRect(x,y+30,64,34);
  ...
  ctx.fillStyle='#f1c40f'; ctx.beginPath(); ctx.moveTo(x+36,y-2); ctx.lineTo(x+58,y-2); ctx.lineTo(x+47,y+10); ctx.closePath(); ctx.fill();
  ctx.fillStyle='#f6c39b'; ctx.beginPath(); ctx.arc(x+14,y+52,8,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#e67e22'; ctx.fillRect(x+8,y+58,12,8);
}
function sceneMiercoles(ctx,x,y){
  ctx.fillStyle='#8b5a2b'; ctx.fillRect(x+10,y-4,44,24);
  ctx.fillStyle='#c0392b'; ctx.fillRect(x+14,y,8,16);
  ctx.fillStyle='#2980b9'; ctx.fillRect(x+26,y,8,16);
  ctx.fillStyle='#27ae60'; ctx.fillRect(x+38,y,8,16);
  ctx.fillStyle=PAL.woodLight; ctx.fillRect(x,y+24,64,40);
...
function sceneJueves(ctx,x,y){
  ctx.fillStyle='#2c1a4d'; ctx.fillRect(x,y-6,64,36);
  ctx.fillStyle='#6c5ce7'; ctx.fillRect(x+8,y,32,20);
  ctx.fillStyle='#fff'; ctx.beginPath(); ctx.moveTo(x+18,y+6); ctx.lineTo(x+18,y+16); ctx.lineTo(x+28,y+11); ctx.closePath(); ctx.fill();
  ctx.fillStyle='#c0392b'; ctx.fillRect(x+4,y+34,14,14); ctx.fillRect(x+22,y+34,14,14); ctx.fillRect(x+40,y+34,14,14);
}
function sceneViernes(ctx,x,y){
  ctx.fillStyle='#d63384'; ctx.fillRect(x,y+40,32,20);
  ctx.fillStyle='#e91e63'; ctx.fillRect(x+32,y+40,32,20);
  ctx.fillStyle='#f6c39b'; ctx.beginPath(); ctx.arc(x+20,y+22,7,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#f39c12'; ctx.fillRect(x+14,y+28,12,14);
  ctx.fillStyle='#c68642'; ctx.beginPath(); ctx.arc(x+44,y+22,7,0,Math.PI*2); ctx.fill();
  ctx.fillStyle='#2980b9'; ctx.fillRect(x+38,y+28,12,14);
...
function sceneFinal(ctx,x,y){
  ...
  ctx.fillStyle='#2ecc71'; ctx.beginPath(); ctx.moveTo(x+30,y-8); ctx.lineTo(x+58,y-2); ctx.lineTo(x+30,y+4); ctx.closePath(); ctx.fill();
  ctx.fillStyle='#6c757d'; ctx.fillRect(x+6,y+40,52,10);
